...
#include "TwinStickShooter/Fountain.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	TWINSTICKSHOOTER_API UClass* Z_Construct_UClass_AFountain_NoRegister();
	TWINSTICKSHOOTER_API UClass* Z_Construct_UClass_AFountain();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFountain_Statics::NewProp_Body_MetaData[] = {
		{ "Category", "Fountain" },
		{ "Comment", "// VisibleAnywhere : ??????\xc6\xae ?\xd3\xbc??? ?????\xcf\xb1? ???? ?\xca\xbf??? \xc5\xb0????\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Fountain.h" },
		{ "ToolTip", "VisibleAnywhere : ??????\xc6\xae ?\xd3\xbc??? ?????\xcf\xb1? ???? ?\xca\xbf??? \xc5\xb0????" },
	};
#endif
	...
	IMPLEMENT_CLASS(AFountain, 2163142352);
	template<> TWINSTICKSHOOTER_API UClass* StaticClass<AFountain>()
	{
		return AFountain::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFountain(Z_Construct_UClass_AFountain, &AFountain::StaticClass, TEXT("/Script/TwinStickShooter"), TEXT("AFountain"), false, nullptr, nullptr, nullptr);
